...
const Home = () => {
  ...
  return (
    <>
      <section
        className="relative w-screen h-56 lg:h-screen overflow-hidden flex items-center justify-center"
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full flex items-center justify-center">
          ...
          >
            ...
            <video
              className="absolute inset-0 md:w-full md:h-full object-contain md:object-cover z-20 mix-blend-screen pointer-events-none"
            ...
            {shine && (
              <>
                ...
                <div className="absolute top-10 md:top-80 left-0 w-full flex justify-center items-center px-4 md:px-14 z-30 pointer-events-none">
                  <span className="text-white text-sm md:text-lg blur-in-up">©2025</span>
                </div>

                {/* Bottom left */}
                <div className="absolute bottom-4 md:bottom-52 left-4 md:left-48 gap-3 md:gap-7 z-30 pointer-events-none">
                ...
                <div className="absolute bottom-4 md:bottom-52 right-4 md:right-80 flex items-center z-30 pointer-events-none">
                  <span
